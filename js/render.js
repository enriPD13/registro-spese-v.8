...
const TAB_TITLES={
  ...
  entrate:"Entrate",risparmi:"Risparmi",categorie:"Categorie spese",
...
function render(){
  ...
  const fn={riepilogo:renderRiepilogo,calendario:renderCalendario,spese:renderSpese,
    ...
    entrate:renderEntrate,"cat-entrate":renderCatEntrate,risparmi:renderRisparmi}[S.tab];
...
function renderTabs(){
  ...
  const inAltro=S.tab==="categorie"||S.tab==="impostazioni"||S.tab==="entrate"||S.tab==="cat-entrate"||S.tab==="risparmi";
  const tabs=[
