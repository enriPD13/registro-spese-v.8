...
function exportBackup(){
  const blob=new Blob([JSON.stringify({expenses:S.expenses,categories:S.categories,templates:S.templates,incomes:S.incomes,incCategories:S.incCategories,goals:S.goals,taxRate:S.taxRate,taxSaved:S.taxSaved,fcCeiling:S.fcCeiling,rates:S.rates,calDayHours:S.calDayHours,calBreakStart:S.calBreakStart,calBreakEnd:S.calBreakEnd,calMaxHours:S.calMaxHours,calIgnored:S.calIgnored,calOverrides:S.calOverrides,calSkipWords:S.calSkipWords,fisco:S.fisco,fiscoAcconti:S.fiscoAcconti},null,2)],{type:"application/json"});
...
function importBackup(file){
  ...
  r.onload=()=>{
    try{
      ...
      if(d.fisco&&typeof d.fisco==="object")S.fisco=d.fisco;
      if(d.fiscoAcconti&&typeof d.fiscoAcconti==="object")S.fiscoAcconti=d.fiscoAcconti;
      if(d.calOverrides&&typeof d.calOverrides==="object")S.calOverrides=d.calOverrides;
      if(d.calSkipWords!=null)S.calSkipWords=d.calSkipWords;
