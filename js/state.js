...
function icon(n,s){
  ...
  const P={
    ...
    "doc":'<path d="M6.5 3.5h7l4.5 4.5v12.5h-11.5z"/><path d="M13.5 3.5V8h4.5"/><path d="M9 12.5h6M9 16h6"/>',
...
const S={
  ...
  fisco:{scadenze:[],crediti:[],lastImport:0},fiscoAcconti:{},
...
async function persistLocal(){
  const ok=await store.save({expenses:S.expenses,categories:S.categories,apiKey:S.apiKey,
    templates:S.templates,gClientId:S.gClientId,lastSync:S.lastSync,savedAt:S.savedAt,incomes:S.incomes,lastInvoiceSync:S.lastInvoiceSync,incCategories:S.incCategories,fisco:S.fisco,fiscoAcconti:S.fiscoAcconti,expSort:S.expSort,expType:S.expType,expPeriod:S.expPeriod,expFrom:S.expFrom,expTo:S.expTo,scadRange:S.scadRange,scadCat:S.scadCat,scadSort:S.scadSort,goals:S.goals,taxRate:S.taxRate,taxSaved:S.taxSaved,fcCeiling:S.fcCeiling,rates:S.rates,calDayHours:S.calDayHours,calBreakStart:S.calBreakStart,calBreakEnd:S.calBreakEnd,calMaxHours:S.calMaxHours,calEvents:S.calEvents,calList:S.calList,calIgnored:S.calIgnored,calOverrides:S.calOverrides,calSkipWords:S.calSkipWords,calLastSync:S.calLastSync});
