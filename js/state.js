...
const S={
  ...
  filterCat:"all",calFilter:"all",chartRange:6,search:"",busy:"",fcMode:"mesi",fcYear:null,fcCeiling:null,rates:[],calEvents:[],calLastSync:0,calDayHours:8,editId:null,notice:"",error:"",
...
async function persistLocal(){
  const ok=await store.save({expenses:S.expenses,categories:S.categories,apiKey:S.apiKey,
    templates:S.templates,gClientId:S.gClientId,lastSync:S.lastSync,savedAt:S.savedAt,incomes:S.incomes,lastInvoiceSync:S.lastInvoiceSync,incCategories:S.incCategories,goals:S.goals,taxRate:S.taxRate,taxSaved:S.taxSaved,fcCeiling:S.fcCeiling,rates:S.rates,calDayHours:S.calDayHours,calEvents:S.calEvents,calLastSync:S.calLastSync});
